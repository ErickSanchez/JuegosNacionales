...
class CI_Email {
	...
	var	$mailpath		= "/usr/lib/sendmail";	// Sendmail path
	var	$protocol		= "mail";	// mail/sendmail/smtp
	var	$smtp_host		= "mail.prefecomorelia.edu.mx";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "no-reply+sprefecomorelia.edu.mx";		// SMTP Username
	var	$smtp_pass		= "Inter2012";		// SMTP Password
